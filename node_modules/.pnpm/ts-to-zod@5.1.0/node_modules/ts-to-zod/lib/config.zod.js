...
export const customJsDocFormatTypesSchema = z.record(customJsDocFormatTypeSchema, z.union([z.string(), customJsDocFormatTypeAttributesSchema]));
...
export const configsSchema = z.array(configSchema.and(z.object({
    name: z.string(),
})));
