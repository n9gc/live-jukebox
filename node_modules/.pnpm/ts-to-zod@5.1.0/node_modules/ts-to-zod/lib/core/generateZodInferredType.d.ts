 ...
 */
export declare function generateZodInferredType({ aliasName, zodImportValue, zodConstName, typeMetadata, }: GenerateZodInferredTypeProps): ts.TypeAliasDeclaration;
