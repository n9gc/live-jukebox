import type { InputOutputMapping, JSDocTagFilter, NameFilter, CustomJSDocFormatTypes } from "../config.js";
 ...
 */
export declare function generate({ sourceText, nameFilter, jsDocTagFilter, getSchemaName, keepComments, skipParseJSDoc, customJSDocFormatTypes, inputOutputMappings, }: GenerateProps): {
    /**
