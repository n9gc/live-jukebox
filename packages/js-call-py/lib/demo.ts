...
const AddInputCodec = HandlerInputCodec(
	'add',
	[z.number(), z.number()],
);
const AddOutputCodec = HandlerOutputCodec(
	'add',
	z.number(),
);
const SuccInputCodec = HandlerInputCodec(
	'succ',
	[z.number()],
);
const SuccOutputCodec = HandlerOutputCodec(
	'succ',
	z.number(),
);

const AdderInputCodec = ServiceInfoCodec(
	'adder',
	z.union([
...
const AdderOutputCodec = ServiceInfoCodec(
	'adder',
	z.tuple([z.literal('now'), z.number(), z.literal('hello')]),
);

const SuccerInputCodec = ServiceInfoCodec(
	'succer',
	z.union([
...
const SuccerOutputCodec = ServiceInfoCodec(
	'succer',
