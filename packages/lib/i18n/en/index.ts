...
const en: Base = {
	enumKeys: {
		...
		Meaning_ServerPrompt: 'A message from server',
	...
	i18n: {
		...
		enum: {
			notEnum: '{symKey: string} is not a correct Enum',
			notEnumKey: '{keyLL: string} is not key of any Enum. All Enum keys: {keys: string[]|log_keys}',
			notEnumName: '{name: string} is not the name of any Enum. All Enum names: {names: string[]|log_names}',
